...
public class AVLTree < E
    ...
    /**
     * Array List remove yardımcı olması için
     */
...
/**
 * remove methodu gelen İtem mevcut ise siler 
 * yok ise İllegel Exceptionı fırlatır
 * @param data
 * @return 
 */
  @Override
  public boolean remove(E data){
     // System.out.println(List.toString());
      if(List.remove(data) == false){
          throw new IllegalStateException("geçersiz");
      }
      //System.out.println(List.toString());
      AVLTree<E> tempTree = new AVLTree<E>();
      for (int i = 0; i < List.size(); i++) {
          tempTree.add(List.get(i));
